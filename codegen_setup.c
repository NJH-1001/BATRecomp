...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "BATRECOMP_PROJECT_ROOT",
    .build_dir_env = "BATRECOMP_BUILD_DIR",
    .force_setup_env = "BATRECOMP_FORCE_SETUP",
    ...
    .exe_basename = "Battle_Arena_Toshinden_Recompiled",
    .prepare_note =
